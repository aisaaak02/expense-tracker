...
const Modal = ({ isOpen, title, onClose, children }) => {
    ...
    return <div className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full h-[calc(100vh-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50">
